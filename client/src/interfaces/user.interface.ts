...
export type StateDashboard = {
  component: 'user' | 'newDeptCatSubProdData' | 'adminUser' | 'bulkCreateProducts',
...
export enum TypeDashboard {
  ...
  DASHBOARD_LOGIN_DELETE_ERROR_ALL = 'DASHBOARD_LOGIN_DELETE_ERROR_ALL',
...
export type PayloadDashboard = {
  ...
  [TypeDashboard.DASHBOARD_LOGIN_DELETE_ERROR_ALL]: 'No'
