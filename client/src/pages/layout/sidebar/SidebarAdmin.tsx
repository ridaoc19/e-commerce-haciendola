...
const item: ISidebar.ItemRole[] = [
  ...
  { id: 'edit', value: "newDeptCatSubProdData", type: "Crear Producto", svg: 'shop' },
  { id: 'admin', value: "bulkCreateProducts", type: "Crear Productos Excel", svg: 'user' },
  { id: 'super', value: "adminUser", type: "Administrar Usuarios", svg: 'user' },
];
